...
import { trackLeadConversion } from '../../utils/tracking';
...
const LeadForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const success = await sendLeadEmail(dataToSend);
      
      if (success) {
        // Track lead conversion with form data
        trackLeadConversion(dataToSend);
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <select
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              className="w-full sm:w-auto sm:min-w-[140px] px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-sm"
            >

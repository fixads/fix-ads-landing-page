...
export const content = {
  ...
  he: {
    ...
    servicePage: {
      ...
      seoDescription:
        "שירותי FixAds לעסקים בישראל ובעולם: ניהול קמפיינים, חנויות אונליין, פניות איכותיות, אתרים, Klaviyo, אוטומציות ומדידה. גלו מה כל שירות כולל.",
      eyebrow: "השירותים של FixAds",
      title: "השירותים שמחברים בין שיווק לתוצאות עסקיות.",
      intro:
        "מפרסום ממומן ובניית אתרים ועד שימור לקוחות, אוטומציות ומדידה. אפשר להתחיל משירות אחד או לבנות תהליך שמחבר בין הפרסום, הפנייה והמכירה.",
      ...
      faqItems: [
        {
          ...
          answer:
            "פרפורמנס הוא שיווק שנבחן לפי תוצאות מדידות, כמו פניות איכותיות, רכישות ועלות גיוס לקוח. ב־FixAds בודקים גם את מה שקורה אחרי הקליק — באתר, בטיפול בפנייה ובתהליך המכירה — כדי להבין איך הפרסום תורם לעסק.",
        },
        {
          question: "איך בוחרים איפה לפרסם?",
          answer:
            "בוחרים לפי קהל היעד, המוצר או השירות, שוק הפעילות והתקציב. בוחנים היכן הלקוחות מחפשים או מגלים את ההצעה שלכם, ואיך העסק יטפל בפניות או בהזמנות. הניסיון שלנו כולל Google, Meta, Amazon ו־Yelp; לא כל פלטפורמה מתאימה לכל עסק או לכל שוק.",
        },
        {
          question: "איך בודקים אם הפניות באמת מתאימות לעסק?",
          answer:
            "לא מסתפקים במספר הטפסים שנשלחו. מגדירים עם העסק מהי פנייה רלוונטית — למשל לפי השירות המבוקש ואזור הפעילות — ובודקים מה התקדם לשיחה, לפגישה, להצעת מחיר או למכירה. משלבים את המידע הזמין מהקמפיין וממערכת ניהול הלקוחות, בהתאם לתהליך ולנתונים שאפשר לאמת.",
        },
        {
          question: "איך Shopify, Klaviyo, פרסום ממומן ואנליטיקה עובדים יחד?",
          answer:
            "Shopify משמשת לניהול החנות, ו־Klaviyo מאפשרת לבנות אימיילים ותהליכים לפי פעולות הלקוח, כמו הרשמה, נטישת עגלה ורכישה. הפרסום מביא קהל לחנות, והמדידה עוזרת להבין אילו ביקורים הפכו לרכישות והיכן כדאי לשפר את התהליך.",
        },
        {
          question: "מתי נכון לחבר את Odoo?",
          answer:
            "כשיש צורך להעביר מידע בין האתר, פניות הלקוחות, המכירות או התפעול, אפשר לבחון חיבור ל־Odoo. קודם מגדירים איזה מידע צריך לעבור ומי ישתמש בו, ואז בודקים אם מתאים חיבור קיים או פיתוח ממוקד. היקף החיבור תלוי במערכת ובצרכים שלכם.",
        },
      ],
      ...
      ctaBody:
        "ספרו לנו מה העסק צריך עכשיו. נבחן את הפעילות הקיימת ונגדיר יחד מטרה, היקף עבודה ונקודת התחלה.",
      cta: "בואו נדבר",
      back: "חזרה לאתר",
      explore: "לשירותים",
    },
    ...
    services: [
      ...
      },
      {
        ...
        tags: ["Klaviyo", "מסע לקוח", "שימור לקוחות"],
      },
      {
        ...sharedServices.automation,
...
for (const [locale, growth] of Object.entries(growthContent)) {
  ...
  Object.assign(page.seo, {
    ...
    he: { title: "סוכנות שיווק דיגיטלי לעסקים | פרסום, לידים ומכירות | FixAds", description: "FixAds לעסקים בישראל ובעולם: פרסום ב־Google וב־Meta, חנויות אונליין, Klaviyo, בוטים ואוטומציות. מחברים שיווק, אתרים וטיפול בפניות סביב המטרות שלכם." }
  }[locale]);
}
